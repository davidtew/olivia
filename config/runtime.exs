...
# Configure S3/Tigris for file uploads
config :ex_aws,
...
config :ex_aws, :s3,
  scheme: "https://",
  host: System.get_env("S3_HOST") || "fly.storage.tigris.dev",
  region: System.get_env("AWS_REGION") || "auto"

config :olivia, :uploads,
  bucket: System.get_env("S3_BUCKET") || "olivia-gallery",
  public_url: System.get_env("S3_PUBLIC_URL") || "https://fly.storage.tigris.dev/olivia-gallery"

# Configure email sending with Resend
config :olivia, Olivia.Mailer,
  adapter: Swoosh.Adapters.Resend,
  api_key: System.get_env("RESEND_API_KEY")

config :olivia, :emails,
  from_email: System.get_env("FROM_EMAIL") || "noreply@oliviagraham.com",
...
#
#     PHX_SERVER=true bin/olivia start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :olivia, OliviaWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :olivia, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
